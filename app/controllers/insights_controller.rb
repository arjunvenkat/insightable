class InsightsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @insight.save
        format.html { redirect_to :back, notice: 'Insight was successfully created.' }
  ...
  def destroy
    @insight.destroy
    respond_to do |format|
      format.html { redirect_to :back, notice: 'Insight was successfully destroyed.' }
  ...
  private
    ...
    def insight_params
      params.require(:insight).permit(:contents, :insightable_id, :insightable_type, :user_id)
    end
end
