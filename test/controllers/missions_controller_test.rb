...
class MissionsControllerTest < ActionController::TestCase
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post :create, mission: { company: @mission.company, customer_point_of_contact: @mission.customer_point_of_contact, date: @mission.date }
    end
  ...
  test "should update mission" do
    patch :update, id: @mission, mission: { company: @mission.company, customer_point_of_contact: @mission.customer_point_of_contact, date: @mission.date }
    assert_redirected_to mission_path(assigns(:mission))
  end
